 ...
 */
    struct tokenizeResult tokenizeids(int* ids, int num_ids, int *splits, int len_splits, int64_t *token_pairs, int token_pairs_count, int init_tokens, int num_threads){
